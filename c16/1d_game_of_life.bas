0 rem c16/plus4 1d life — millen/byte YYXYY (outer totalistic 624)
1 rem evolution view: each gen a screen row; wrap ring; restart 20 gen
2 rem colors: black bg/border, boot lilac fg (TED $6E)
5 graphic 0
...
110 gosub 1000
120 goto 60
400 rem step: 1d rule — birth ny=2|3, survive ny=2|4 (Y-neighbors only)
410 for x=0 to 39
...
690 return
800 rem seed — ~28-35% live (40-wide ring: sparse dies, dense floods)
805 r=rnd(-ti)
...
790 return
1000 rem digits: pop@4, seed%@20 (block 15-24 centered), gen@35
